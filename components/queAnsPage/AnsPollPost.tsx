...
const AnsPost = ({ answers, postTitleWithSpaces, postId }: Props) => {
    ...
    const fetchData = async () => {
      ...
      if (postId) {
        const ansQuery = query(
          ...
          where("questionId", "==", postTitleWithSpaces),
  ...
  const loadMoreAnswers = useCallback(async () => {
    ...
    setLoading(false);
  }, [postTitleWithSpaces, lastAnswer, setMoreAnswers, setDispAnswer, setLastAnswer, setLoading]);
  ...
  return (
    <div className="bg-[#E8EAF6] dark:bg-[#1F2937] mt-3 font-dmsans">
      {dispAnswer.length > 0 &&
          ...
          >
            ...
            <div className="dark:bg-[#1A1A1B]/65 z-20 flex justify-between gap-x-3 text-sm px-4 py-4 sm:px-6">
              ...
              <div className="flex gap-x-3">
                ...
                <ShareDialog postLink={`/poll/${postTitleWithSpaces}`}/>
                </button>
