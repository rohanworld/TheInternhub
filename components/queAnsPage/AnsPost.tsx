            ...
            <div className="px-6 py-5 flex justify-between">
              <div className="w-0 flex-1">
                <div className="flex justify-between max-h-40 mt-1 space-x-2 text-xs">
                  ...
                  <span className="font-style-5-username font-dmsans  mt-3 text-[#0c0c0c] text-sm font-semibold dark:text-white">
                    {answer.anonymity ? (
                      "Anonymous"
                    ) : (
                      <Link
                  ...
                  <div className="mt-[11px] font-style-4 font-dmsans ">{answer?.createdAt?.toDate()?.toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</div>
                </div>
            ...
            <div className="dark:bg-[#1A1A1B]/65 z-20 flex justify-between gap-x-3 text-sm px-4 py-4 sm:px-6">
              ...
              <div className="flex gap-x-3">
                ...
                >
                  ...
                  <span className="sm:block hidden font-style-3 font-jakarta ">
                ...
                <button className="w-fit flex items-center gap-2">
                  ...
                  <span className="sm:block hidden font-style-4 font-dmsans ">Save</span>
                </button>
              </div>
            </div>
