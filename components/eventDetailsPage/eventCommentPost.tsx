          ...
          <div className="px-6 py-5">
            ...
            <div className="">
              <div className="flex w-full max-h-40 mt-1 space-x-2 text-xs text-gray-500">
                ...
                {/* </div> */}
                <span className="mt-3 font-style-5-username font-dmsans  text-[#0c0c0c] dark:text-white">{eventComment.name}</span>
                </div>
            ...
            <p className="ProseMirror font-style-4 font-dmsans ">{eventComment.comment ? parse(eventComment.comment) : ""}</p>
