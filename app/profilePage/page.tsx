...
import ProfileCard from "@/app/profilePage/ProfileCard";
...
useEffect(() => {
  const fetchSavedPosts = async () => {
    ...
    if (userDoc.exists()) {
      ...
      const savedPostsPromises = savedPostIds?.length? savedPostIds?.map((postId: string) => {
...
useEffect(() => {
  ...
  return (
    <div className='bg-layout md:container md:max-w-[84rem] md:mx-auto mt-3 pt-3'>
