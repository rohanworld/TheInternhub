        ...
        <div className="  w-full cursor-pointer">
                      <Form {...form}>
                        ...
                        >
                          ...
                          render = {({field}) => (
                            <FormItem>
                              <FormLabel><h2 className="text-lg">Forum Name</h2></FormLabel>
                              <FormControl>
                                <Input className="" placeholder="Give a Unique Forum Name..." {...field}/>
                              </FormControl>
                              <div className="text-sm opacity-70">This is for forum url, Give a Unique Forum Name here</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
                          ...
                          render = {({field}) => (
                            <FormItem>
                              <FormLabel><h2 className="text-lg">Display Name</h2></FormLabel>
                              <FormControl>
                                <Input className="" placeholder="Give a name to your Forum" {...field}/>
                              </FormControl>
                              <div className="text-sm opacity-70">This name will be visible to the users, Give a Forum Name here</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
                          ...
                          render = {({field}) => (
                            <FormItem>
                              <FormLabel><h2 className="text-lg">Upload forum logo</h2></FormLabel>
                              <FormControl>
                              ...
                              <div className="text-sm opacity-70">Upload a logo for your Forum here.</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          ...
                          <FormField
                            ...
                            render = {({field}) => (
                              <FormItem>
                                <FormLabel><h2 className="text-lg">Description</h2></FormLabel>
                                <div className={`${isFocused?"border-black border-[2.1px]": "border-[1.2px]"} rounded-lg bg-white dark:bg-black`} onFocus={() => setIsFocused(true)}
                                ...
                                <div className="text-sm opacity-70">Give a description and set banner of your forum from here.</div>
                                <FormMessage/>
                              </FormItem>
                            )}
                          />
                          ...
                          <SelectContent>
                            <SelectGroup>
                              <SelectLabel><h2 className="text-lg">Categories</h2></SelectLabel>
                              <div>
                                  {
                                    selectCategory?
                        ...
                        <div className="flex">
                            ...
                            {selectedMainCategory && (
                              <Select value={""} onValueChange={handleSubcategoryChange}>
                                ...
                                <SelectContent>
                                  <SelectGroup>
                                  <SelectLabel><h2 className="text-lg">Sub Categories</h2></SelectLabel>
                                    {
                          ...
                          render = {({field}) => (
                            <FormItem>
                              <FormLabel><h2 className="text-lg">Set Rules for Forum</h2></FormLabel>
                              <FormControl>
                                <Input className="" placeholder="Set Some Rules for your Forum" {...field}/>
                              </FormControl>
                              <div className="text-sm opacity-70">Here you can write some Rules for the forum</div>
                              <FormMessage/>
                            </FormItem>
                          )}
                          />
