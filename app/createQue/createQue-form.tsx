  ...
  useEffect(() => {
    if (user) {
      const fetchMainUser = async () => {
        ...
        setMainUser({uid : docSnap.id, ...docSnap.data()});
      };
      fetchMainUser();
    }
    
  }, [user]);
  console.log("User in Ques : ", mainUser);
          ...
          >
            ...
            render = {({field}) => (
              <FormItem>
                ...
                <FormControl>
                  <Input className="bg-white dark:bg-gray-950" placeholder="Title for the question ..." {...field}/>
                </FormControl>
                <div className="opacity-70">This is the title, write your question here.</div>
                <FormMessage/>
              </FormItem>
            )}
            />
            ...
            <FormField
              ...
              render = {({field}) => (
                <FormItem>
                  ...
                  <div className={`${isFocused?"border-black border-[2.1px]": "border-[1.2px]"} rounded-lg bg-white dark:bg-gray-950`} onFocus={() => setIsFocused(true)}
                  ...
                  <div className="opacity-70">This is the description, give more details about your question here.</div>
                  <FormMessage/>
                </FormItem>
              )}
            />
            ...
            <div className="mt-3">
              ...
              <div className="opacity-70 mt-2">This is the category, you can choose multiple categories for your Question.</div>
            </div>
            ...
            <div className="mb-1">Polls</div>
              ...
              <div className=" flex flex-col gap-1">
                {polls.map((poll, index) => (
                  <div
                    key={index}
                    className=" flex gap-1 justify-between p-2 mt-2 rounded-xl bg-white dark:bg-gray-800"
                  >
